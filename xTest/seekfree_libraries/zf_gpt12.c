...
//-------------------------------------------------------------------------------------------------------------------
sint16 gpt12_get(GPTN_enum gptn)
{
	switch(gptn)
	{
		case GPT12_T2: return (sint16)IfxGpt12_T2_getTimerValue(&MODULE_GPT120);
		case GPT12_T3: return (sint16)IfxGpt12_T3_getTimerValue(&MODULE_GPT120);
		case GPT12_T4: return (sint16)IfxGpt12_T4_getTimerValue(&MODULE_GPT120);
		case GPT12_T5: return (sint16)IfxGpt12_T5_getTimerValue(&MODULE_GPT120);
		case GPT12_T6: return (sint16)IfxGpt12_T6_getTimerValue(&MODULE_GPT120);
		default: return 0;
	}
}
